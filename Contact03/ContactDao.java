...
public interface ContactDao {
	 ...
	 * @return 저장에 성공하면 1을 리턴, 실패하면 0을 리턴
	 */
	int create(Contact c); //인터페이스라 public abstract 생략 가능함
	 ...
	 * @return 연락처 배열(Contact[])을 리턴해줄 수 있으면 Main은 화면에다가 그거를 print하면 됨<- 이걸 생각하면서 설계
	 */
	Contact[] read();
