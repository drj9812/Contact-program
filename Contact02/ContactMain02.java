...
//			enumMenu enmenu = enumMenu.enumIndexReturn(n);

			int menu = app.showMainMenu();
			Menu enmenu = Menu.enumIndexReturn(menu);
...
//			END, SAVE, LIST, INDEX, EDIT, DELETE, UNKNOWN;
			...
			case LIST: // 연락처 전체 목록 보여주기
				...
				break;
			case INDEX: // 배열의 인덱스로 검색하기
				app.searchContactByIndex();
				break;
			case EDIT: // 연락처의 이름/전화번호/email 정보 수정
	...
	private static Menu enumIndexReturn(int menu) {
